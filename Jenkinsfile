pipeline {
    ...
    environment {
         ...
         appname='react-springboot-backend'                       // appname that you want
         namespace= 'deploy-backend'                         // namespace that you want
         servicename = 'react-springboot-backend'                 // servicename that you want
